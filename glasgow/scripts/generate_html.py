...
# 2️⃣ unique count of year-month per grid
df_count = (
...
# 4️⃣ lat-lon offset grid =  20m × 20m
...
print("✅ map saved to streetview_grid_year_count_squares_modern.html")
...
# 1️⃣ load data
csv_path = (
    "/mnt/home/2715439w/sharedscratch/fairness/glasgow/results/"
...
colormap = colormap.to_step(index=tick_positions)  
colormap.caption = "Most Recent Available Year (Old → New)"

# 6️⃣ lat-lon offset grid =  20m × 20m
...
print("✅ map saved to streetview_grid_latest_date.html")
